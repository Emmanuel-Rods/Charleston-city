/**
 * Fetches contact details from the Wake County EnerGov API.
 *
...
async function get_contacts(
  ...
  const url =
    "https://egcss.charleston-sc.gov/EnerGov_Prod/selfservice/api/energov/entity/contacts/search/search";
