/**
 * Fetches inspection details from the Wake County EnerGov API.
 *
 * @param {string} entityId - The ID of the permit entity.
 * @param {Object} options - Optional overrides for the JSON payload (e.g., PageNumber).
...
async function get_inpection(entityId, options = {}) {
  ...
  // but allow the user to easily override them using the options parameter
  const payload = {
    PageNumber: 1,
    PageSize: 100,
    SortField: "",
